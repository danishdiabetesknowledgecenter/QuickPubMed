<?php
/**
 * CheckIfResourceIsForbidden API Proxy
...
// Azure Function URL
define('AZURE_FUNCTION_URL', 'https://qpm-openai-service.azurewebsites.net/api/CheckIfResourceIsForbidden');
...
// Get raw request body and forward unchanged
