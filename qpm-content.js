...
const filtrer = [
    {
        ...
        choices: [
            ...
            },
            {
                ...
                maintopic: true,
                subtopiclevel: 1,
                maintopicIdLevel1: 'L00020', // Angiver at dette punkt er underpunkt til det punktet med det angivne name.
                translations: {
                    dk: 'Afgrænsning 2.1',
                    en: 'Limit 2.1'
                }, 
            ...
            },
            {
                ...
                id: 'L00040',
                buttons: true,
                subtopiclevel: 2, // Angiver at dette punkt ligger på 2. niveau
                maintopicIdLevel1: 'L00020', // Angiver at dette punktet på 1. niveau til det punktet med det angivne name.
                maintopicIdLevel2: 'L00030', // Angiver at dette punktet på 2. niveau til det punktet med det angivne name.
                translations: {
    ...
    },
    {
        ...
        choices: [
            {
                name: 'L10010', buttons: true, id: 'L10010',
                translations: {
                    dk: 'Systematiske reviews',
                    en: 'Systematic reviews',
                }, ordering: { dk: 1, en: 1 }, simpleSearch: true, standardSimple: true, 
                tooltip_simple: {
            ...
            {
                name: 'L10020', buttons: false, id: 'L10020',
                maintopic: true,
                subtopiclevel: 1,
                maintopicIdLevel1: 'L10010', // Angiver at dette punkt er underpunkt til det punktet med det angivne name.
                translations: {
                    dk: 'Cochrane Reviews',
                    en: 'Cochrane Reviews'
                }, ordering: { dk: 2, en: 2 }, simpleSearch: true, standardSimple: false,
                tooltip_simple: {
            ...
            {
                name: 'L10030', buttons: false, id: 'L10030',
                subtopiclevel: 2,
                maintopicIdLevel1: 'L10020', // Angiver at dette punkt er underpunkt til det punktet med det angivne name.
                translations: {
                    dk: 'Guidelines',
                    en: 'Guidelines'
    ...
    },
    {
        ...
        translations: {
            ...
            },
            {
                ...
                }, ordering: { dk: null, en: 5 }, simpleSearch: true, standardSimple: false,
                tooltip_simple: {
            ...
            },
            {
                ...
                }, ordering: { dk: null, en: 6 }, simpleSearch: true, standardSimple: false,
                tooltip_simple: {
            ...
            {
                name: 'Randomiserede, kontrollerede forsøg', buttons: true, id: 'L20050',
                translations: {
                    dk: 'Randomiserede, kontrollerede forsøg',
                    en: 'Randomized controlled trials'
                }, ordering: { dk: null, en: 7 }, simpleSearch: false, standardSimple: false,
                tooltip_simple: {
                    dk: "",
                    en: ""
                }, searchStrings: {
            ...
            {
                name: 'Økonomiske studier', buttons: true, id: 'L20060',
                translations: {
        ...
        translations: {
        ...
        }, ordering: { dk: 3, en: 3 }, allowCustomInput: true, choices: [
            {
                ...
                translations: {
                    dk: 'Engelsk',
                    en: 'English'
                }, ordering: { dk: 1, en: 1 }, simpleSearch: false, standardSimple: true,
                tooltip_simple: {
            ...
            },
            {
                ...
                translations: {
                    dk: 'Dansk',
                    en: 'Danish'
                }, ordering: { dk: 2, en: 2 }, simpleSearch: false, standardSimple: true,
                tooltip_simple: {
        ...
        translations: {
            ...
            },
            {
                ...
                translations: {
                    dk: 'Nordiske lande',
                    en: 'Nordic countries'
                }, ordering: { dk: 3, en: 3 }, simpleSearch: false, standardSimple: false,
                tooltip_simple: {
    ...
    {
        name: 'Publiceringsdato', id: 'L80',
        translations: {
            dk: 'Publiceringsdato',
            en: 'Publication date'
        }, ordering: { dk: 7, en: 7 }, allowCustomInput: false, choices: [
            {
                name: 'Seneste 1 år', buttons: false, id: 'L80010',
                translations: {
                    dk: 'Seneste 1 år',
                    en: 'Last 1 year'
                }, ordering: { dk: 1, en: 1 }, searchStrings: {
                    normal: ['y_1[Filter]'],
                },
                searchStringComment: {
                    dk: "",
            ...
            {
                name: 'Seneste 5 år', buttons: false, id: 'L80020',
                translations: {
                    dk: 'Seneste 5 år',
                    en: 'Last 5 years'
                }, ordering: { dk: 1, en: 1 }, searchStrings: {
            ...
            {
                name: 'Seneste 10 år', buttons: false, id: 'L80030',
                translations: {
                    dk: 'Seneste 10 år',
                    en: 'Last 10 years'
                }, ordering: { dk: 1, en: 1 }, searchStrings: {
    ...
    },
    {
        ...
        translations: {
            ...
            en: 'Other limits'
        }, ordering: { dk: 8, en: 9 }, allowCustomInput: false, choices: [
            {
            ...
            {
                name: 'Kun resultater med abstracts', buttons: false, id: 'L70030',
                translations: {
            ...
            {
                name: 'Kun gratis tilgængelige artikler', buttons: false, id: 'L70040',
                translations: {
