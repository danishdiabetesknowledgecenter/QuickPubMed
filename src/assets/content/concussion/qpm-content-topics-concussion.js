...
export const topics = [
  ...
  },
  {
    ...
    groups: [
      {
        ...
        searchStrings: {
          ...
          normal: [
            '"concussi*"[tiab] OR "mild traumatic brain injur*"[tiab] OR "mTBI"[tiab] OR "commotio"[tiab]'
          ],
          broad: [
            ''
          ],
        ...
        searchStringComment: {
          dk: "Forholdsvis stringent søgetreng, som vil reducere risiko for at inkludere litteratur omkring moderat til svært hovedtraume. En del relevant litteratur vil dog også blive sorteret fra.",
          en: "Fairly stringent search string, which will reduce the risk of including literature on moderate to severe head trauma. However, some relevant literature will also be excluded.",
        },
        tooltip: {
          dk: "Forholdsvis stringent søgetreng, som vil reducere risiko for at inkludere litteratur omkring moderat til svært hovedtraume. En del relevant litteratur vil dog også blive sorteret fra.",
          en: "Fairly stringent search string, which will reduce the risk of including literature on moderate to severe head trauma. However, some relevant literature will also be excluded.",
      ...
      },
      {
        ...
        searchStrings: {
          ...
          normal: [
            '"concussi*"[tiab] OR "mild traumatic brain injur*"[tiab] OR "mTBI"[tiab] OR "mild TBI"[tiab] OR "minor traumatic brain injur*"[tiab] OR "minor TBI"[tiab] OR "brain concussion"[mh] OR "minor head injur*"[tiab] OR "mild head injur*"[tiab] OR "mild head trauma"[tiab] OR "minor head trauma"[tiab] OR "minor brain injur*"[tiab] OR "mild brain injur*"[tiab]'
          ],
          broad: [
            ''
          ],
        ...
        searchStringComment: {
          dk: "En mere inkluderende søgestreng. Med denne søgestreng sikrer vi særligt, at litteraturen fra traumatologien omkring akut vurdering og håndtering inkluderes. Denne medfører dog også risiko for inklusion af studier, som rækker ud over hjernerystelse.",
          en: "A more inclusive search string. With this search string, we specifically ensure that the literature from trauma medicine regarding acute assessment and management is included. This, however, also increases the risk of including studies that go beyond concussion.",
        },
        tooltip: {
          dk: "En mere inkluderende søgestreng. Med denne søgestreng sikrer vi særligt, at litteraturen fra traumatologien omkring akut vurdering og håndtering inkluderes. Denne medfører dog også risiko for inklusion af studier, som rækker ud over hjernerystelse.",
          en: "A more inclusive search string. With this search string, we specifically ensure that the literature from trauma medicine regarding acute assessment and management is included. This, however, also increases the risk of including studies that go beyond concussion.",
    ...
    tooltip: {
      dk: "Testkategori for hjernerystelse",
      en: "Test category for concussion",
    },
  },
  {
    id: "S010",
