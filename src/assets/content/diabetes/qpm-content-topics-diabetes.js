            ...
            children: [
              {
                ...
                ordering: { dk: 4, en: 4 },
                searchStringComment: { dk: "Eksempel på niveau 3 med underemner.", en: "Example of level 3 with children." },
                tooltip: { dk: "Eksempel på niveau 3 med underemner.", en: "Example of level 3 with children." },
                children: [
                  {
                    id: "S000020010010010",
                    name: "S000020010010010",
                    buttons: true,
                    translations: { dk: "Underemne 2.1.1.1", en: "Subtopic 2.1.1.1" },
                    ordering: { dk: 1, en: 1 },
                    searchStringComment: { dk: "Eksempel på niveau 4 med underemner.", en: "Example of level 4 with children." },
                    tooltip: { dk: "Eksempel på niveau 4 med underemner.", en: "Example of level 4 with children." },
                    children: [
                      {
                        id: "S000020010010010010",
                        name: "S000020010010010010",
                        buttons: true,
                        translations: { dk: "Underemne 2.1.1.1.1", en: "Subtopic 2.1.1.1.1" },
                        ordering: { dk: 1, en: 1 },
                        searchStringComment: { dk: "Eksempel på niveau 5 med underemner.", en: "Example of level 5 with children." },
                        tooltip: { dk: "Eksempel på niveau 5 med underemner.", en: "Example of level 5 with children." },
                        children: [
                          {
                            id: "S00002001001001001001",
                            name: "S00002001001001001001",
                            buttons: true,
                            translations: { dk: "Underemne 2.1.1.1.1.1", en: "Subtopic 2.1.1.1.1.1" },
                            ordering: { dk: 1, en: 1 },
                            searchStrings: { narrow: ['xxx'], normal: ['xxx'], broad: ['xxx'] },
                            searchStringComment: { dk: "Eksempel på niveau 6.", en: "Example of level 6." },
                            tooltip: { dk: "Eksempel på niveau 6.", en: "Example of level 6." },
                          },
                          {
                            id: "S00002001001001001002",
                            name: "S00002001001001001002",
                            buttons: true,
                            translations: { dk: "Underemne 2.1.1.1.1.2", en: "Subtopic 2.1.1.1.1.2" },
                            ordering: { dk: 2, en: 2 },
                            searchStrings: { narrow: ['xxx'], normal: ['xxx'], broad: ['xxx'] },
                      ...
                      {
                        id: "S000020010010010020",
                        name: "S000020010010010020",
                        buttons: true,
                        translations: { dk: "Underemne 2.1.1.1.2", en: "Subtopic 2.1.1.1.2" },
                        ordering: { dk: 2, en: 2 },
                        searchStrings: { narrow: ['xxx'], normal: ['xxx'], broad: ['xxx'] },
                        searchStringComment: { dk: "", en: "" },
                        tooltip: { dk: "", en: "" },
                  ...
                  {
                    id: "S000020010010020",
                    name: "S000020010010020",
                    buttons: true,
                    translations: { dk: "Underemne 2.1.1.2", en: "Subtopic 2.1.1.2" },
                    ordering: { dk: 2, en: 2 },
                    searchStrings: { narrow: ['xxx'], normal: ['xxx'], broad: ['xxx'] },
                    searchStringComment: { dk: "", en: "" },
                    tooltip: { dk: "", en: "" },
