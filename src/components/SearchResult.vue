      ...
      >
        ...
        <template #listItem="value">
          ...
          <result-entry
            ...
            :open-alex-id="value.model.openAlexId || ''"
            :pub-type-classification="value.model.pubTypeClassification || null"
          ...
          <ul class="qpm_resetList qpm_resultEntriesList">
            ...
            >
              <result-entry
                ...
                :open-alex-id="value.openAlexId || ''"
                :pub-type-classification="value.pubTypeClassification || null"
                :volume="value.volume"
                :issue="value.issue"
                :pages="value.pages"
